...
static const struct fsdata_file file_favicon = {
name_favicon,
data_favicon,
sizeof(data_favicon),
0,
...
static const struct fsdata_file file_logo_jpg = {
name_logo_jpg,
data_logo_jpg,
...
static const struct fsdata_file file_ST_gif = {
name_ST_gif,
data_ST_gif,
sizeof(data_ST_gif),
0,
...
static const struct fsdata_file file_stm32_jpg = {
name_stm32_jpg,
data_stm32_jpg,
...
static const struct fsdata_file file_ADC_shtml = {
name_ADC_shtml,
data_ADC_shtml,
...
static const struct fsdata_file file_LED_html = {
name_LED_html,
data_LED_html,
...
const uint32_t FS_NUMFILES = sizeof(fs_files)/sizeof(struct fsdata_file *);
